...
project = '{{ app_name }}'
copyright = '2013, {{ author_name|default:"<AUTHOR_NAME>" }}'
...
latex_documents = [
  ('index', '{{ app_name }}.tex', '{{ app_name }} Documentation',
   '{{ author_name }}', 'manual'),
]
...
man_pages = [
    ('index', '{{ app_name }}', '{{ app_name }} Documentation',
     ['{{ author_name }}'], 1)
]
...
texinfo_documents = [
  ('index', '{{ app_name }}', '{{ app_name }} Documentation',
   '{{ author_name }}', '{{ app_name }}', '{{ short_description }}',
   'Miscellaneous'),
]
